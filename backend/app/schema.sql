...
CREATE INDEX IF NOT EXISTS idx_resources_patient_type ON resources (patient_id, type);
CREATE INDEX IF NOT EXISTS idx_resources_patient_time ON resources (patient_id, effective_at);
